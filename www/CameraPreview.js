...
options.ts = options.ts || '0';
exec(onSuccess, onError, PLUGIN_NAME, "startCamera", [options.x, options.y, options.width, options.height, options.camera, options.tapPhoto, options.previewDrag, options.toBack, options.alpha,options.ts,options.index]);
};
...
opts.ts = opts.ts || '0';
opts.isdoc = opts.isdoc || false;
exec(onSuccess, onError, PLUGIN_NAME, "takePicture", [opts.width, opts.height, opts.quality, opts.index, opts.ts,opts.isdoc]);
};
